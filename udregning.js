...
//Her er klasser der indeholder alle formerne: Linjer, Cirkler, Firkanter & Trekanter
class Line{
...
//Her er klasserne for formerne (Bold, Kapsel, Boks, Stjerne, Væg)
class Body{
    constructor(x, y){
        this.comp = [];
        this.pos = new Vector(x, y);
...
//Her sker Kolisionerne
//Der bliver indsamlet data for kolisionerne hvert frame
class CollData{
    ...
    collRes(){
        //Her sker udregningerne for Hastighed
...
//Her bliver der regnet vektorer ud
function sat(o1, o2){
    let minOverlap = null;
    let smallestAxis;
    let vertexObj;
...
//returnere minimum og maximum projektion værdier af en form på en akse
...
//finder den projekteret akse af et objekt
...
//gentages igennem et objekts vertex og returnere den der er tættest på det givne punkt
...
//returnere tal af en akse der tilhører et objekt
...
//Boldens retning bliver regnet om hele tiden, så den rykker sig som forventet
...
//Her sørger for at et objekt ikke kan komme ud af canvas
